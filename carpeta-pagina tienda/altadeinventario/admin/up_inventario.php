...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
	...
	$up = $con->prepare("UPDATE productos SET producto = :producto, cantidad = :cantidad, precio = :precio, categoria = :categoria, foto = :foto, descripcion = :descripcion WHERE clave = :clave ");
