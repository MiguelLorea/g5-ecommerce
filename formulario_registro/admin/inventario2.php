	...
	<div class="card text-white bg-secondary">
			...
			<div class="card-body">
				<form action="ins_inventario.php" method="post" autocomplete="off" enctype="multipart/form-data">
					...
					<div class="form-group">
						<input type="text" name="cuil" required placeholder="Cuil" class="form-control">
					</div>
...
<div class="form-group">
						<input type="text" name="nombredemarca" required placeholder="Nombre de marca" class="form-control">
					</div>
...
<div class="form-group">
						<input type="password" name="contrase" required placeholder="Contraseña" class="form-control">
					</div>


					<div class="form-group">
						<input type="number"  required name="precio" placeholder="Precio" class="form-control">
					</div>
					<div class="form-group">
					...
					<div class="form-group">
						<input name="direccion"  required placeholder="Direccion" class="form-control"></input>
					</div>
		...
		<div class="card text-white bg-dark" style="margin-top: 1%;">
				...
				<div class="card-body">
					...
					<table class="table">
						...
						<tbody>
							<?php 
							$sel = $con->prepare("SELECT * FROM inventario ORDER BY id DESC limit 20 ");
							$sel->execute();
							  	while ($f = $sel->fetch()) {  ?>
							  	<tr>
							  		<td><img src="<?php echo $f['foto'] ?>" width="50" heigth="50" ></td>
							  		<td></td> <?php echo $f['nombredeusuario'] ?>
